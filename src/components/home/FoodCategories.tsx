...
const reels = [
  ...
  },
  {
    id: 4,
    title: "Persian CC 01",
    videoUrl: "/CB PERSIAN CC 01.webm"
  },
];
...
const FoodCategories = () => (
  <section className="bg-muted py-20 md:py-28">
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 lg:gap-10 max-w-5xl mx-auto">
        {reels.map((reel, i) => (
          <ScrollReveal key={reel.id} delay={i * 0.2}>
            <div className="group relative block overflow-hidden rounded-3xl bg-black shadow-warm aspect-square sm:aspect-[9/16] cursor-pointer">
              <video
                src={reel.videoUrl}
                autoPlay
                loop
