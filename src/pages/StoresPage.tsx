...
const stores = [
  ...
  { name: "IIT Indore (Madhya Pradesh)", address: "IIT Indore, Madhya Pradesh", image: "/IIT Indore(Madhya Pradesh).webp", mapUrl: "https://www.google.com/maps/search/CafeBeats+IIT+Indore,+Madhya+Pradesh" },
];
